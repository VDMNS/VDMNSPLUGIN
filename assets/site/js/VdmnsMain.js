jQuery(function($) {
    ...
    $(document).find('.vdmns-btn-add').click(function (e) {
        var userName, userMessage, data;
        // Получаем данные формы
        userName = $(this).parent().find('.vdmns-user-name').val();
        userMessage = $(this).parent().find('.vdmns-message').val();
        ...
        // Запрещаем отправление формы что бы страница не перезагружалас
        return false;
    });
});