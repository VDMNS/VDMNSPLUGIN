...
class VdmnsGuestBookSubMenuController extends VdmnsBaseAdminMenuController
{
    ...
    public function render()
    {
        ...
        */
        ...
        switch($action) {
            ...
            case "add_data":
                $pathView .= "/includes/views/admin/menu/VdmnsGuestBookSubMenuAdd.view.php";
            ...
            case "insert_data":
                ...
                if (isset($_POST)){
                     ...
                     */
                    $this->redirect("admin.php?page=vdmns_control_guest_book_menu");
                }
            ...
            case "edit_data":
                ...
                */
                if(isset($_GET['id']) && !empty($_GET['id'])){
                    ...
                    $data = VdmnsGuestBookSubMenuModel::getById((int)$_GET['id']);
                    $pathView .= "/includes/views/admin/menu/VdmnsGuestBookSubMenuEdit.view.php";
                    $this->loadView($pathView, 0, $data);
                }
                break;
            ...
            case "update_data":
                ...
                if (isset($_POST)){
                    ...
                    VdmnsGuestBookSubMenuModel::updateById(
                        array(
                            'user_name' => $_POST['user_name'],
                            'date_add' => time(),
                            'message' => $_POST['message']
            ...
            case "delete_data":
                ...
                // Проверяем его наличие и на пустоту
                if(isset($_GET['id']) && !empty($_GET['id'])){
                    VdmnsGuestBookSubMenuModel::deleteById((int)$_GET['id']);
                }
                $this->redirect("admin.php?page=vdmns_control_guest_book_menu");
                break;
            ...
            default:
                ...
                $pathView .= "/includes/views/admin/menu/VdmnsGuestBookSubMenu.view.php";
                $this->loadView($pathView, 0, $data);
        }
    }
    /**
