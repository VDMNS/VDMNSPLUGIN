...
class VdmnsGuestBookDashboardWidget implements VdmnsICreatorInstance
{
    ...
    public function addDashboardWidgets(){
        ...
        add_meta_box(
            'vdmns_guest_book_dashboard_widget_new',
            __('Guest book new', VDMNS_PlUGIN_TEXTDOMAIN),
        ...
        wp_add_dashboard_widget(
            'vdmns_guest_book_dashboard_widget',         // Идентификатор виджета.
            __('Guest book', VDMNS_PlUGIN_TEXTDOMAIN),           // Заголовок виджета.
        ...
        $example_widget_backup = array('vdmns_guest_book_dashboard_widget' => $normal_dashboard['vdmns_guest_book_dashboard_widget']);
        unset($normal_dashboard['vdmns_guest_book_dashboard_widget']);
    ...
    public function renderDashboardWidget(){
        ...
        $data = VdmnsGuestBookSubMenuModel::getAll();
        // Вывод данных
        ?>
        <table  border="1">
            <thead>
            <tr>
                <td>
                    <?php _e('Name', VDMNS_PlUGIN_TEXTDOMAIN ); ?>
                </td>
                <td>
                    <?php _e('Messsage', VDMNS_PlUGIN_TEXTDOMAIN ); ?>
                </td>
                <td>
                    <?php _e('Date', VDMNS_PlUGIN_TEXTDOMAIN ); ?>
                </td>
